...
def matchset(pattern, text):
    ...
    if 'lit' == op:
        ...
        # my solution has a problem in dealing with tuples
        return set([text[len(x):]]) if text[:len(x)] in x else null # your code here
        # peter's solution. need to change x into a tuple instead of a string
...
#    assert matchset(('oneof', ('a', 'b')), 'aabc123')           == set(['abc123'])
