...
def oneof(chars):   return lambda Ns: set([c for c in chars if 1 in Ns])# my solution doesn't handle null case when there's no match
def oneof(chars):   return lambda Ns: set(chars) if 1 in Ns else null# Peter's solution
