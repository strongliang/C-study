...
# this version is not efficient as each recursive call gets a bunch of duplicates. 
# the problem is that each recursive call doesn't know what the caller has already seen. 
#def crawl_web(seed,max_depth):
#    tocrawl = [seed]
##    print 'depth: ', max_depth, "tocrawl: ", tocrawl
#    crawled = []
#    if max_depth>=0:
#        page = tocrawl.pop()
